...
<section class="page-intro">
    <div class="container content-grid">
        <div class="panel">
            <span class="pill"><?php echo e($offer['type']); ?> · <?php echo e($offer['status']); ?></span>
            ...
            <div class="hero-actions">
                ...
                <?php endif; ?>
                <a class="btn btn-secondary" href="<?php echo e(url('/negozio/' . ($store['slug'] ?? ''))); ?>">Vai al negozio</a>
            </div>
        </div>
        <aside class="stack">
            <div class="info-card">
                <h3>Dettagli coupon</h3>
                <?php if ($discountLabel !== ''): ?>
                    <p class="muted">Sconto: <?php echo e($discountLabel); ?></p>
                <?php endif; ?>
                <p class="muted">Scadenza: <?php echo e($offer['expires_at']); ?></p>
                <p class="muted">Badge: <?php echo e($offer['badge']); ?></p>
            </div>
            <div class="info-card">
                <h3>Tracking GDPR</h3>
                <p class="muted">Il redirect affiliato minimizza l'IP e registra solo i dati tecnici essenziali.</p>
            </div>
        </aside>
    </div>
</section>
