...
return [
    ...
    ['method' => 'GET', 'pattern' => '/contatti', 'handler' => [PageController::class, 'contact']],
    ['method' => 'POST', 'pattern' => '/contatti', 'handler' => [PageController::class, 'contactSubmit'], 'middleware' => [App\Middleware\CsrfMiddleware::class]],
