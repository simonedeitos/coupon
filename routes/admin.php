...
use App\Controllers\Admin\TradeDoublerController;
...
return [
    ...
    ['method' => 'POST', 'pattern' => '/admin/tradedoubler/import', 'handler' => [TradeDoublerController::class, 'import'], 'middleware' => [AuthMiddleware::class, CsrfMiddleware::class]],
];
